//Program By SMB Corporation written by Ahmed Sura.

//Paste this code in dev c++ compiler to run it.

//Print Any Name in Star Pattern

//Enter Any Word Without space or With Space for next Line

//In c we are not able to type sentences using spaces between two words.
...
for(j=10;j>=i;j--)
 ...
 void crosstl()  //same top triangle (left)
{
for(j=10;j>=i;j--)
	{
		printf(" ");
...
for(l=1;l<=i;l++)
 ...
 void crossbl()//same bottom triangle (left)
{
for(j=1;j<=i;j++)
	{
		printf(" ");
...
//Now we will paste the code written in text editor...
